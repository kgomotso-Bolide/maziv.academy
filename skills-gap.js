...
(function(){
  ...
  var SKILLS=[
    ...
    {k:'tech',  n:'Network &amp; technical systems',l:'network and technical systems',
     d:'Fibre, splicing, cabling, fault-finding and the network management tools'},
  ...
  var ROLES=[
    {k:'dctech',  n:'Fibre / Network Technician',    t:{ai:3,data:3,tech:4,comms:2,report:2,admin:3,resp:3,lead:1}},
  ...
  var PROF=(typeof window!=='undefined'&&window.MazivProfile)||null;
  var prefilled=false;
  if(PROF&&PROF.exists()){
    var pp=PROF.get();
  ...
  function renderStep1(){
    return '<div class="sg-card">'+
      ...
      '<p class="sg-intro">This shapes what we compare you against — a target for a fibre technician is not the target for someone in network operations.</p>'+
      (prefilled?'<p class="prefill-note">Filled in from <a href="profile">your profile</a>. Change anything that\'s moved on since.</p>':'')+
      '<div class="two">'+
        sel('sgRole',ROLES,'Your role at Maziv')+
